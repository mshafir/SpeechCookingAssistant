...
public class SpeechStateControl extends javax.swing.JComponent implements
	...
	public SpeechStateControl(Dimension size) {
		...
		ImagePanel bar = new ImagePanel("images/bar.png", new Dimension(
				this.getWidth(), 100));
		bar.setVisible(true);
		this.add(bar);
		bar.setBounds(0, this.getHeight() - 100, bar.getWidth(),
				bar.getHeight());
	}
